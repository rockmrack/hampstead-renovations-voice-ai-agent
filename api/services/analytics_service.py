...
class ConversationAnalytics:
    ...
    def avg_sentiment(self) -> float:
        ...
        return sum(self.sentiment_scores) / len(self.sentiment_scores) if self.sentiment_scores else 0
...
class AnalyticsService:
        ...
        if data_file.exists():
            try:
                ...
                self._daily_stats = defaultdict(
                    lambda: {"conversations": 0, "messages": 0, "bookings": 0, "avg_sentiment": 0, "sentiment_sum": 0},
    ...
    def _extract_insights(self, conv: ConversationAnalytics, content: str) -> None:
        ...
        service_keywords = {
            ServiceInterest.KITCHEN_EXTENSION: ["kitchen", "extension", "open plan", "rear extension"],
            ...
            ServiceInterest.FULL_RENOVATION: ["full renovation", "whole house", "complete renovation", "gut renovation"],
        ...
        for service, keywords in service_keywords.items():
            if any(kw in content_lower for kw in keywords):
                if service not in conv.service_interests:
        ...
        # Common keywords
        important_keywords = [
            "price", "cost", "budget", "quote", "timeline", "planning",
            "survey", "visit", "appointment", "urgent", "asap", "quickly"
        ]
